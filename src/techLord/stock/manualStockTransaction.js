    ...
    if (isSellOnly) {
        ...
        while (true) {
            ...
            if (currentBuyPrice <= maxBuyPrice) {
                ...
                ns.print(
                    `Current buy price of ${stockSymbol} ($${currentBuyPrice.toFixed(2)}) is higher than max buy price ($${maxBuyPrice.toFixed(2)}). Waiting...`,
                );
            }
    ...
    while (true) {
        ...
        if (sharesOwned > 0) {
            ...
            if (!isSellOnly) {
                ...
                if (
                    (currentSellPrice >= minSellPrice && currentSellPrice > boughtPrice) ||
