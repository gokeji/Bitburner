...
const defaultMaxSpendPerTickTransientEquipment = 0.01; // If the --equipment-budget is not specified, spend up to this percent of non-reserved cash on temporary upgrades (equipment)
