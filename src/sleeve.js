...
const argsSchema = [
    ...
    ["train-to-strength", 60], // Sleeves will go to the gym until they reach this much Str
    ["train-to-defense", 60], // Sleeves will go to the gym until they reach this much Def
