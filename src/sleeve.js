...
const argsSchema = [
    ...
    ["train-to-dexterity", 35], // Sleeves will go to the gym until they reach this much Dex
    ["train-to-agility", 35], // Sleeves will go to the gym until they reach this much Agi
